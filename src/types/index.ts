...
export type RoadStatus = 'OPEN' | 'RESTRICTED' | 'BLOCKED' | 'NORMAL_TRIP' | 'REROUTED' | 'RECOMMENDED' | 'BACKGROUND_DIM';
export type SyncStatus = 'PENDING' | 'SYNCING' | 'SYNCED';
export type LanguageCode = 'en' | 'as' | 'bn' | 'mni' | 'lus' | 'kha' | 'brx' | 'bdo' | 'hi';
